    ...
    <div className="bg-cyber-gray/90 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden shadow-glass">
      ...
      <div className="relative" style={{ height: '500px' }}>
        ...
        >
          ...
          {/* Simple World Map Path (Approximation for visual context) */}
          <path
            d="M 150 80 L 160 70 L 180 70 L 200 90 L 220 80 L 250 100 L 240 120 L 200 130 L 160 110 Z M 300 150 L 320 140 L 340 150 L 330 180 L 310 170 Z M 400 80 L 420 70 L 450 80 L 460 100 L 440 110 L 410 100 Z M 500 60 L 550 60 L 600 80 L 580 100 L 530 90 Z M 650 150 L 670 140 L 700 150 L 720 180 L 680 190 Z M 750 250 L 780 240 L 800 260 L 770 280 Z"
