...
import type { MonitoringStatus, ThreatSummary, MapPoint, MonitoringAgent, AgentRolloutStatus, AgentUpdateHistory } from '../types';
...
export default function MonitoringPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [statusData, summaryData, mapData, agentsData, rolloutData, historyData] = await Promise.all([
